package com.byondxtremes.ecom.auth.controller;
...
import com.byondxtremes.ecom.auth.mapper.UserMapper;
import com.byondxtremes.ecom.auth.repository.UserRepository;
import com.byondxtremes.ecom.auth.service.JwtUserDetailsService;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> registerAccount(@RequestBody SignUpRequest signUpRequest) {
        userRepository.save(userMapper.toUserEntity(signUpRequest, bCryptPasswordEncoder));
